...
commander
    ...
    .option("-s, --supp-dir <path>", "Specifies the root directory for Brackets supporting files such as user extensions, configurations and state persistence. The default locations is ~/.srv.")
...
var app = brackets(commander.port, {
    supportDir: commander.suppDir || path.join(homeDir, ".srv"),
